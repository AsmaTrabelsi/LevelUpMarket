        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfflinePlayEnable = table.Column<bool>(type: "bit", nullable: false),
                    Available = table.Column<bool>(type: "bit", nullable: false),
                    Genres = table.Column<string>(type: "nvarchar(200)", nullable: false),
                    VoiceLanguages = table.Column<string>(type: "nvarchar(200)", nullable: false),
                    Subtitles = table.Column<string>(type: "nvarchar(200)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainCharacter = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlateformesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GamePlateforme", x => new { x.GamesId, x.PlateformesId });
                    table.ForeignKey(
                        name: "FK_GamePlateforme_Games_GamesId",
                        column: x => x.GamesId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GamePlateforme_Plateformes_PlateformesId",
                        column: x => x.PlateformesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GamePlateforme_PlateformesId",
                table: "GamePlateforme",
                column: "PlateformesId");
